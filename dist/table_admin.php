...
if (isset($_GET['hapus'])) {
  ...
  // Proses hapus data admin dari database
  $hapus = $conn->query("DELETE FROM admin WHERE id_admin = $idAdmin");
  
  if ($hapus) {
    $_SESSION['create_status_hapus'] = 'success';
          ...
          <li class="menu-header">Dashboard</li>
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li><a class="nav-link" href="layout-transparent.html">Pembayaran</a></li>
        ...
        <section class="section">
          ...
          <div class="row">
              <div class="col-12">
                ...
                if (isset($_SESSION['create_status_hapus'])) {
                  if ($_SESSION['create_status_hapus'] == 'success') {
                      echo '<div class="alert alert-success">Data berhasil dihapus.</div>';
                  } else {
                      echo '<div class="alert alert-danger">Terjadi kesalahan saat Hapus data. Silakan coba lagi.</div>';
                  }
                  // hapus session setelah ditampilkan
                  unset($_SESSION['create_status_hapus']);
                }

                if (isset($_SESSION['create_status_edit'])) {
                  if ($_SESSION['create_status_edit'] == 'success') {
                      echo '<div class="alert alert-success">Data berhasil diedit.</div>';
                  } else {
                      echo '<div class="alert alert-danger">Terjadi kesalahan saat Edit data. Silakan coba lagi.</div>';
                  }
                  // hapus session setelah ditampilkan
                  unset($_SESSION['create_status_edit']);
                }
                    ...
                    <div class="table-responsive">
                      <table class="table table-bordered table-md">
                        ...
                        <tr>
                          ...
                          <a href="?hapus=<?php echo $pecah['id_admin']; ?>" class="btn-danger btn">Hapus</a></td>
                        </tr>
                        <?php 
                        $nomorUrut++;
                      } ?>
