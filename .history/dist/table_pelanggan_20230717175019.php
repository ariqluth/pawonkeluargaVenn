...
if (isset($_GET['hapus'])) {
  ...
  $check = $conn->query("SELECT * FROM pelanggan WHERE id_pelanggan = $idPelanggan");
  if ($check->num_rows > 0) {
     
    $error = "Pelanggan tidak dapat dihapus karena sedang digunakan dalam Pembayaran. Harap hapus atau ubah Pembayaran terlebih dahulu.";
  } else {
  // Proses hapus data pelanggan dari database
  $hapus = $conn->query("DELETE FROM pelanggan WHERE id_pelanggan = $idPelanggan");
                    ...
                    <div class="table-responsive">
                      <table class="table table-bordered table-md">
                        ...
                        <tr>
                          ...
                          <td><a href="edit_pelanggan.php?id=<?php echo $pecah['id_pelanggan']; ?>" class="btn btn-warning">Edit</a>
                          <a href="?hapus=<?php echo $pecah['id_pelanggan']; ?>" class="btn-danger btn" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?')">Hapus</a></td>
                        </tr>
                        <?php 
                        $nomorUrut++;
                      } ?>
